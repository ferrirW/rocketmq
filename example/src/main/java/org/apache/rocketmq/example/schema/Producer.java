...
import com.xiaomi.example.Payment;
...
public class Producer {
    public static void main(String[] args) throws MQClientException, InterruptedException {
         ...
         */
        SchemaMQProducer<Payment> producer = new SchemaMQProducer<Payment>(new Properties());
        ...
        for (int i = 0; i < 1; i++) {
            try {
                ...
                SchemaMessage<Payment> msg = new SchemaMessage<>("TopicTest7", "TagA", "key", payment);

                /*
                 * Call send message to deliver message to one of brokers.
                 */
                System.out.println("send msg: " + msg);
                System.out.println("send origin msg: " + msg.getOriginMessage());
