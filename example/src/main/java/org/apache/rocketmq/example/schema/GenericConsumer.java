...
public class GenericConsumer {
    ...
    public static void main(String[] args) throws MQClientException {
        ...
        props.setProperty("schema.type", "avro");
        props.setProperty("schema.parse.type", "generic");

        SchemaMQPushConsumer<GenericRecord> consumer = new SchemaMQPushConsumer<GenericRecord>(props);
